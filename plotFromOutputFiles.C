...
void plotFromOutputFiles() {
   ...
   Float_t  arrayAX200[arraySize] = {0}; // Measured range straggling from full MC
   Float_t  arrayAP200[arraySize] = {0};
   Float_t  arrayError200[arraySize] = {0}; // Measured range straggling from full MC
   ...
   Float_t  arrayAXB100230[arraySize] = {0}; // Measured range straggling from full MC
   ...
   Float_t  arrayAXAdipose230[arraySize] = {0}; // Measured range straggling from full MC
   ...
   Float_t  arrayAXCorticalBone230[arraySize] = {0}; // Measured range straggling from full MC
   ...
   Float_t  arrayAXA150230[arraySize] = {0}; // Measured range straggling from full MC
   ...
   Float_t  arrayError230[arraySize] = {0}; // Measured range straggling from full MC
   Float_t  arrayAX230[arraySize] = {0}; // Measured range straggling from full MC
